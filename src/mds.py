...
if __name__ == "__main__":
    ...
    nanopub.add_argument("--real", action="store_true", help="do not use the nanopub testnet",
                         default=False)
    nanopub.add_argument("-n", "--nanopub", action="store_true", help="create a nanopub")
    ...
    utils.add_argument("-d", "--debug", action="store_true", help="enable debugging output",
                       default=False)
    ...
    if args.nanopub:
        create_nanopub(data_object, use_testnet=not args.real,
